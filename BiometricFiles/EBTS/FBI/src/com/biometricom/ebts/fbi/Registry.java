...
public class Registry
{
	...
	{
		TransactionFactory.registerTransaction(new TransactionDefinition("EBTS-FBI", "9.2", "CAR", Transaction.STD_VERSION_2000, "com.biometricom.ebts.fbi.CriminalAnswerRequiredTransaction"));
	}
}
